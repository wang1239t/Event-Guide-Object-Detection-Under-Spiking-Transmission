...
def ms_resnet50_snn(return_interm_indices=None, steps=None, **kwargs):
    if return_interm_indices is None:
        return_interm_indices = [0, 1, 2, 3]
    model = ms_snn_ResNet(snn_Bottleneck, [3, 4, 6, 3], return_interm_indices, steps=steps, **kwargs)
    return model