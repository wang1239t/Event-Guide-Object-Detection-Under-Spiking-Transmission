...
from config.SOD.EGSTNet_5scale import STEPS_VALID, ALPHA, VTH, TAU, Pt
...
class tdLayer(nn.Module):
    def __init__(self, layer, bn=None, steps=STEPS_VALID):
...
class LIFSpike(nn.Module):
    def __init__(self, steps=STEPS_VALID):
