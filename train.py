...
def main(args):
    ...
    train_type = str('train' + args.dataset_type)
    val_type = str('val' + args.dataset_type)
    dataset_train = build_dataset(image_set=train_type, args=args)
    dataset_val = build_dataset(image_set=val_type, args=args)
    ...
    data_loader_val = DataLoader(dataset_val, 1, sampler=sampler_val, drop_last=False, collate_fn=utils.collate_fn,
                                 num_workers=args.num_workers)
